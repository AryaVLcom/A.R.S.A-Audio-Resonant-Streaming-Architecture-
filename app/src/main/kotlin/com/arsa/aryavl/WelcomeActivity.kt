...
import com.arsa.aryavl.constants.IsFirstRunKey
...
val GoogleSansFlex = FontFamily(
    Font(
        resId = com.arsa.aryavl.R.font.google_sans_flex,
...
fun WelcomePagerScreen(onFinished: () -> Unit) {
    ...
    val customWelcomeFontFamily = FontFamily(
        Font(
            resId = com.arsa.aryavl.R.font.sans_flex,
            variationSettings = FontVariation.Settings(
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.arsa.aryavl.R.string.welcome_to),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.arsa.aryavl.R.string.app_name).uppercase(),
                    ...
                    Row(
                        ...
                        Surface(
                            ...
                            modifier = Modifier.clickable {
                                uriHandler.safeOpenUri(context, "https://aryavl.com")
                            }
                        ) {
                            Text(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(com.arsa.aryavl.R.string.welcome_preparing_subtitle),
                            fontFamily = GoogleSansFlex,
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.arsa.aryavl.R.string.perm_required),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.arsa.aryavl.R.string.perm_permissions),
                        fontFamily = GoogleSansFlex,
                        fontWeight = FontWeight.Bold,
                        fontSize = 48.sp,
                        color = MaterialTheme.colorScheme.primary,
                    ...
                    Text(
                        text = stringResource(com.arsa.aryavl.R.string.perm_intro_text),
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            title = stringResource(com.arsa.aryavl.R.string.perm_notif_title),
                            description = stringResource(com.arsa.aryavl.R.string.perm_notif_desc),
                        ...
                        if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                            ...
                            PermissionCard(
                                ...
                                title = stringResource(com.arsa.aryavl.R.string.perm_install_title),
                                description = stringResource(com.arsa.aryavl.R.string.perm_install_desc),
            ...
            content = { onUpdateScroll ->
                Column(
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Text(
                            text = stringResource(com.arsa.aryavl.R.string.feat_discover),
                            style = thinHeaderStyle,
                            color = MaterialTheme.colorScheme.onBackground
                        )
                        Text(
                            text = stringResource(com.arsa.aryavl.R.string.feat_features),
                            fontFamily = GoogleSansFlex,
                            fontWeight = FontWeight.Bold,
                            fontSize = 48.sp,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        Text(
                            text = stringResource(com.arsa.aryavl.R.string.feat_intro),
                            style = MaterialTheme.typography.bodyLarge.copy(
                                fontFamily = GoogleSansFlex
                            ),
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        ...
                        Column(
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = stringResource(com.arsa.aryavl.R.string.feat_lyrics_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_lyrics_desc),
                                shape = topCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.arsa.aryavl.R.string.feat_download_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_download_desc)
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffb683),
                                iconTint = Color(0xFF753403),
                                title = stringResource(com.arsa.aryavl.R.string.feat_quality_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_quality_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.arsa.aryavl.R.string.feat_glass_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_glass_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.arsa.aryavl.R.string.feat_discord_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_discord_desc),
                                shape = middleCardShape
                            )
                            ...
                            if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                                ...
                                FeatureCard(
                                    ...
                                    iconColor = Color(0xFF67d4ff),
                                    iconTint = Color(0xFF004e5d),
                                    title = stringResource(com.arsa.aryavl.R.string.feat_update_title),
                                    description = stringResource(com.arsa.aryavl.R.string.feat_update_desc),
                                    shape = middleCardShape
                                )
                            }
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.arsa.aryavl.R.string.feat_license_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_license_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFcabeff),
                                iconTint = Color(0xFF1c0062),
                                title = stringResource(com.arsa.aryavl.R.string.feat_github_title),
                                description = stringResource(com.arsa.aryavl.R.string.feat_github_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                icon = painterResource(com.arsa.aryavl.R.drawable.arsa_logo),
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = "Made by Arya VL",
                                description = "Audio Resonent Streaming Architecture • aryavl.com",
                                shape = bottomCardShape,
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = stringResource(com.arsa.aryavl.R.string.back_button_desc),
                        onClick = {
                            if (!isFirstPage) {
                                scope.launch {
                                    pagerState.animateScrollToPage(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = if (isLastPage) stringResource(com.arsa.aryavl.R.string.get_started) else stringResource(
                            com.arsa.aryavl.R.string.next
                        ),
                        onClick = {
                            if (isLastPage) {
            ...
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable { uriHandler.safeOpenUri(context, "https://aryavl.com") }
                    .padding(bottom = 8.dp),
                horizontalArrangement = Arrangement.Center,
                verticalAlignment = Alignment.CenterVertically
            ) {
...
fun RotatingShapeContainer(modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Icon(
            painter = painterResource(id = com.arsa.aryavl.R.drawable.ic_ten_sided_cookie),
            contentDescription = null,
            tint = primaryColor,
            modifier = Modifier
                .fillMaxSize()
        ...
        Icon(
            painter = painterResource(com.arsa.aryavl.R.drawable.ic_launcher_monochrome),
            contentDescription = null,
