...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ContentCountryKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ContentLanguageKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.SuggestionRegionKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.SuggestionRegionSlugToName
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.ui.screens.search.suggestions.SuggestionRegionSheet
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.CountryCodeToName
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.EnableSimpMusicKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.EnableYouLyPlusKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.EnablePaxsenixKey
...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.AlbumCanvasEnabledKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.LanguageCodeToName
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.LyricsProviderOrderKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ProxyEnabledKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ProxyPasswordKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ProxyTypeKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ProxyUrlKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ProxyUsernameKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.QuickPicks
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.QuickPicksKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowArtistDescriptionKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowArtistSubscriberCountKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowMonthlyListenersKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowArtistVideoKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowArtistBackgroundVideoKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.ShowWrappedCardKey
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.constants.TopSize
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.lyrics.LyricsProviderRegistry
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.ui.component.DraggableLyricsProviderItem
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.ui.component.DraggableLyricsProviderList
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import androidx.compose.runtime.mutableStateListOf
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.utils.PlaybackLogManager
import com.arsa.aryavl.utils.YTPlayerUtils
import com.arsa.aryavl.utils.YouTubeClientProbe
...
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
import com.arsa.aryavl.ui.component.PlaybackLogsDialog
import com.arsa.aryavl.ui.utils.appTopBarWindowInsets
...
fun ContentSettings(
    ...
    var songSuggestionsEnabled by remember {
        mutableStateOf(com.arsa.aryavl.playback.recommendation.MusicRecommendationHelper.getSongSuggestionsEnabled(context))
    }
                ...
                TextButton(
                    ...
                    onClick = {
                        clientProbeOutput?.let { text ->
                            ...
                            clipboard?.setPrimaryClip(ClipData.newPlainText("Arsa client probe", text))
                        }
        ...
        Material3SettingsGroup(
            ...
            items = listOf(
                ...
                Material3SettingsItem(
                    ...
                    title = { Text(stringResource(R.string.song_suggestions_title)) },
                    description = { Text(stringResource(R.string.song_suggestions_desc)) },
                    trailingContent = {
                        Switch(
                            checked = songSuggestionsEnabled,
                            onCheckedChange = { checked ->
                                songSuggestionsEnabled = checked
                                com.arsa.aryavl.playback.recommendation.MusicRecommendationHelper.setSongSuggestionsEnabled(context, checked)
                            },
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                                        id = if (songSuggestionsEnabled) R.drawable.check else R.drawable.close
                                    ),
                                    contentDescription = null,
                    ...
                    onClick = {
                        val newValue = !songSuggestionsEnabled
                        songSuggestionsEnabled = newValue
                        com.arsa.aryavl.playback.recommendation.MusicRecommendationHelper.setSongSuggestionsEnabled(context, newValue)
                    }
                ),
                Material3SettingsItem(
                    icon = painterResource(R.drawable.play),
                    title = { Text(stringResource(R.string.song_suggestions_test)) },
                    description = { Text(stringResource(R.string.song_suggestions_channel_desc)) },
                    onClick = {
                        scope.launch {
                            val sent = com.arsa.aryavl.playback.recommendation.MusicRecommendationHelper.sendRecommendation(context, isTest = true)
                            val msg = if (sent) {
                                context.getString(R.string.song_suggestions_test_sent)
                            } else {
                                "Failed to send suggestion (check notifications permission)"
                            }
