...
import com.arsa.aryavl.ui.component.rememberPlaylistCoverPicker
            ...
            NewActionGrid(
                actions = listOfNotNull(
                    ...
                    NewAction(
                        ...
                        onClick = {
                            onDismiss()
                            val browseId = dbPlaylist?.playlist?.browseId ?: playlist.playlist.browseId
                            val isLocalOrPrivate = playlist.playlist.isLocal || browseId == null || autoPlaylist == true
                            val trackIds = songs.map { it.id }
                            com.arsa.aryavl.utils.ShareHelper.sharePlaylist(
                                context = context,
                                playlistId = browseId,
                                isPrivateOrLocal = isLocalOrPrivate,
                                title = playlist.playlist.name,
                                trackIds = trackIds,
                                coroutineScope = coroutineScope
                            )
