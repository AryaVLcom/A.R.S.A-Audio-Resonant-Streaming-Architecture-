...
import com.arsa.aryavl.constants.PlaylistViewTypeKey
...
import com.arsa.aryavl.ui.component.LibraryPlaylistGridItem
import com.arsa.aryavl.ui.component.LibraryPlaylistListItem
...
import com.arsa.aryavl.viewmodels.LibraryPlaylistsViewModel
        ...
        when (viewType) {
            LibraryViewType.LIST -> {
                LazyColumn(
                    ...
                    item(key = "playlists_list_footer") {
                        AppFooter()
                    }
                }
            ...
            LibraryViewType.GRID -> {
                LazyVerticalGrid(
                    ...
                    item(key = "playlists_grid_footer", span = { GridItemSpan(maxLineSpan) }) {
                        AppFooter()
                    }
                }
