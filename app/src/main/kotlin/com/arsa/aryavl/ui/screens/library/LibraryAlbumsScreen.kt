...
import com.arsa.aryavl.ui.component.LibraryAlbumListItem
...
import com.arsa.aryavl.viewmodels.LibraryAlbumsViewModel
        ...
        when (viewType) {
            ...
            LibraryViewType.GRID ->
                LazyVerticalGrid(
                    ...
                    item(key = "albums_grid_footer", span = { GridItemSpan(maxLineSpan) }) {
                        AppFooter()
                    }
                }
        }
