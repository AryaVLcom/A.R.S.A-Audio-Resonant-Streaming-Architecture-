package com.arsa.aryavl.vivimusic
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/workflows/nightly.yml/main/arsa-gms-nightly.zip"
        } else {
            "https://github.com/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/releases/download/$versionName/arsa-$versionName.apk"
        }
