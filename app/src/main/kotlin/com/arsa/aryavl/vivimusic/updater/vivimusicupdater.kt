...
package com.arsa.aryavl.vivimusic.updater
...
import com.arsa.aryavl.vivimusic.updater.downloadmanager.UpdateDownloadWorker
import com.arsa.aryavl.vivimusic.updater.downloadmanager.DownloadNotificationManager
...
import com.arsa.aryavl.ui.component.ChangelogItem
import com.arsa.aryavl.ui.component.leadingItemShape
import com.arsa.aryavl.ui.component.middleItemShape
import com.arsa.aryavl.ui.component.endItemShape
import com.arsa.aryavl.ui.component.detachedItemShape
import com.arsa.aryavl.ui.component.AnimatedActionButton
import com.arsa.aryavl.ui.component.ExpressiveIconButton
import com.arsa.aryavl.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/releases/download/${currentStatus.version}/arsa-${currentStatus.version}.apk"
                                ...
                                Column(
                                    ...
                                    currentStatus.changelog.forEach { section ->
                                        ...
                                        section.items.forEachIndexed { index, item ->
                                            val shape = when {
                                                section.items.size == 1 -> com.arsa.aryavl.ui.component.detachedItemShape()
                                                index == 0 -> com.arsa.aryavl.ui.component.leadingItemShape()
                                                index == section.items.size - 1 -> com.arsa.aryavl.ui.component.endItemShape()
                                                else -> com.arsa.aryavl.ui.component.middleItemShape()
                                            }
                                            com.arsa.aryavl.ui.component.ChangelogItem(
                                                text = item,
                                                shape = shape,
...
private fun fetchNightlyArtifactSize(runId: Long): String = try {
    val artifactsUrl =
        URL("https://api.github.com/repos/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/actions/runs/$runId/artifacts")
    ...
    val bytes = (0 until (artifacts?.length() ?: 0))
        ...
        .firstOrNull { it.optString("name") == "arsa-gms-nightly" || it.optString("name") == "convx-gms-nightly" }
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/actions/workflows/nightly.yml/runs?status=success&per_page=1")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/workflows/nightly.yml/main/arsa-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/AryaVLcom/A.R.S.A-Audio-Resonant-Streaming-Architecture-/releases/download/$tagWithPrefix/changelog.json")
