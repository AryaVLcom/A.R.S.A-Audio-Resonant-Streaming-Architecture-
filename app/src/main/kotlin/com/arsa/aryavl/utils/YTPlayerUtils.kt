...
import com.arsa.aryavl.utils.BotDetectionMitigator
...
import com.arsa.aryavl.constants.ForceSelectedQualityKey
import com.arsa.aryavl.constants.SaavnFallbackToYouTubeKey
import com.arsa.aryavl.constants.EnableTidalStreamingKey
import com.arsa.aryavl.constants.EnabledModulesKey
import com.arsa.aryavl.constants.ModuleSourcesKey
import com.arsa.aryavl.constants.ModuleSettingsKey
import com.arsa.aryavl.constants.SaavnAudioQuality
import com.arsa.aryavl.constants.SaavnAudioQualityKey
import com.arsa.aryavl.constants.TidalInstanceUrlKey
import com.arsa.aryavl.constants.TidalQuality
import com.arsa.aryavl.constants.TidalQualityKey
import com.arsa.aryavl.utils.tidal.TidalService
import com.music.spine.ModuleManager
import org.json.JSONArray
import com.arsa.aryavl.utils.cipher.CipherDeobfuscator
import com.arsa.aryavl.utils.YTPlayerUtils.MAIN_CLIENT
import com.arsa.aryavl.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.arsa.aryavl.utils.YTPlayerUtils.validateStatus
import com.arsa.aryavl.utils.potoken.PoTokenGenerator
import com.arsa.aryavl.utils.potoken.PoTokenResult
import com.arsa.aryavl.utils.sabr.EjsNTransformSolver
import com.arsa.aryavl.utils.PlaybackLogLevel
        ...
        if (context != null) {
            ...
            if (!forceStandardAudio && !forceSelectedQuality && allowLossless && context.dataStore.get(EnableTidalStreamingKey, false)) {
                ...
                val tidalResult = runCatching {
                    ...
                    // stream fetch fails.
                    var best: com.arsa.aryavl.utils.tidal.TidalTrack? = null
