...
import com.arsa.aryavl.constants.ListenTogetherAutoAddSuggestionsKey
import com.arsa.aryavl.constants.ListenTogetherAutoApprovalKey
import com.arsa.aryavl.constants.ListenTogetherIsHostKey
import com.arsa.aryavl.constants.ListenTogetherRoomCodeKey
import com.arsa.aryavl.constants.ListenTogetherServerUrlKey
import com.arsa.aryavl.constants.ListenTogetherSessionTimestampKey
import com.arsa.aryavl.constants.ListenTogetherSessionTokenKey
import com.arsa.aryavl.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.arsa.aryavl.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.arsa.aryavl.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.arsa.aryavl.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.arsa.aryavl.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.arsa.aryavl.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.arsa.aryavl.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
